...
const Overview = ({ type, list, setList }: OverviewProps) => {
    ...
    return (
        <div className=' md:flex flex-col rounded-lg shadow mb-5 bg-white w-full '>
            <div className='flex justify-between items-center p-5 '>
                ...
                <Button onClick={() => setIsOpen(true)} className="text-sm sm:text-md !px-18 text-white bg-amber-600 hover:bg-amber-700 border-none capitalize">
                    <Plus /> Add {type}
                </Button>
            </div>
            <div className="h-50">
